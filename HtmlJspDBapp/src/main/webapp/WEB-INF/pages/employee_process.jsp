...
<%!Connection connection = null;
	...
	public void jspInit() {
		...
		try {
			...
			pstmt1 = connection.prepareStatement("insert into employee3(ename,eaddr,esal) values (?,?,?)");
			pstmt2 = connection.prepareStatement("select eid,ename,eaddr,esal from employee3");
